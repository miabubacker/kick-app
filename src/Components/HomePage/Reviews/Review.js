...
import img1 from "../../Assets/Imgs/Elli1.png";
import img2 from "../../Assets/Imgs/Elli2.png";
import img3 from "../../Assets/Imgs/Elli3.png";
...
function Review() {
  const [reviewCard, setReviewCard] = useState([
    {
      header: "Good Quality ",
      comments: "I highly recommend shopping from kicks",
      star: 5,
      profile: img1,
      shoe: reviewshoe1,
    },
                  ...
                  <div>
                    ...
                    <div className="review_stars">
                      ...
                      {[...Array(5)].map((star, index) => {
                        return (
                          <span key={index} className={"reviews_star"}>
                            &#9733;{" "}
                          </span>
                        );
                      })}{" "}
                      <span style={{ marginLeft: "4px" }}>5.0</span>
                    </div>
                  </div>
